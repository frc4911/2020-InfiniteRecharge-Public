...
/**
 * Creates CANSparkMax objects and configures all the parameters we care about to factory defaults. Closed-loop and sensor
...
public class SparkMaxFactory {
    ...
    // Create a CANSparkMax with the default (out of the box) configuration.
